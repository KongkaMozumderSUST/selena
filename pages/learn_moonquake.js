  ...
  return (
    <Box sx={{ m: 8 }}>
      <Typography sx={{ fontFamily: "Comfortaa", fontSize: "14px", m: 8 }}>
        ...
        problem, but obviously, they’re called moonquakes. Since no one lives on
        our lunar neighbor, moonquakes don’t get much attention, but they can be
        incredibly powerful, and last up to 20 times longer than earthquakes on
        Earth! The moon is dry, cool and mostly rigid, like a chunk of stone or
        iron. So moonquakes set it vibrating like a tuning fork. According to
        Neal Armstrong the moon was ringing like a bell when he first felt a
        moonquake. Even if a moonquake isn't intense, it could continue more
        than 10 minutes and for smaller trembling to continue for hours
        afterwards. Neal said, “for a lunar habitat, that persistence could be
        more significant than a moonquake's magnitude”. If we ever decide to
      ...
      <Typography sx={{ fontFamily: "Comfortaa", fontSize: "14px", m: 8 }}>
        ...
        caused by tidal forces. Just as the Moon tugs on the Earth’s surface and
        causes ocean tides here, the Earth pulls on the Moon and deforms it.
        Researchers think that deep moonquakes are probably caused by the Moon
        continuously stretching and relaxing. Shallow Moonquake: Shallow
        moonquakes originate just a few tens of kilometers below the surface.
        Scientists think that shallow moonquakes are probably the result of the
        Moon shrinking over time. The Moon is getting smaller because its
        interior is cooling. This shrinkage—imagine a grape drying into a
        raisin—creates stress within the Moon, which triggers moonquakes near
        the surface. Shallow moonquakes often last longer and are more powerful
        than other types of moonquakes. Meteorite: Moonquakes can be caused by
        impacts. When an asteroid, comet, or meteoroid strikes the Moon’s
        surface, it can trigger moonquakes. Earth’s relatively thick atmosphere
        causes most space debris to burn up from friction before it strikes our
        planet’s surface. But the Moon isn’t so lucky. Because there is almost
        no atmosphere, most space debris heading toward the Moon impacts its
        surface, sometimes causing giant craters and moonquakes. Artificial
        Impact: Artificial Impacts can be caused by objects that are made or
        produced by human beings rather than occurring naturally. These objects
        are launch vehicles and lunar modules that were directed at the lunar
        surface on purpose to create seismic sources of well defined timing and
        location. Saturn V was an American super heavy-lift launch vehicle
        developed by NASA under the Apollo program for human exploration of the
        Moon. Crash landing or launching of these heavy lifting vehicles can
        cause a moonquake. Lunar Module is a small craft used for traveling
        between the moon's surface and an orbiting spacecraft.Lunar module cause
        far lighter impact on the moon than the launch vehicle but the impact
      ...
      <Typography sx={{ fontFamily: "Comfortaa", fontSize: "14px", m: 8 }}>
        ...
        E. "Buzz" Aldrin, Jr., the first men to walk on the Moon. Also included
        on the LM was the Early Apollo Scientific Experiment Package (EASEP),
        which consisted of several self-contained experiments to be deployed and
        left on the lunar surface, and other scientific and sample collection
        ...
        14: The Apollo 14 Lunar Module (LM) "Antares" was the third crewed
        ...
        Surface Experiments Package (ALSEP) containing scientific experiments to
        be deployed and left on the lunar surface and other scientific and
        sample collection apparatus Apollo 15: The Apollo 15 lunar module (LM)
        "Falcon" was the fourth crewed vehicle to land on the Moon. It carried
        two astronauts, Commander David R. Scott and LM pilot James B. Irwin,
        the seventh and eighth men to walk on the Moon. The LM also carried a
        Lunar Roving Vehicle (LRV), an Apollo Lunar Surface Experiments Package
        ...
        Lunar Module (LM) "Challenger" was the sixth and last lunar lander in
        the Apollo program. It carried two astronauts, Commander Eugene A.
        Cernan and LM pilot Harrison H. Schmitt, the eleventh and twelfth men to
        walk on the Moon. Schmitt was the first scientist-astronaut to walk on
        the Moon. The LM also carried a Lunar Roving Vehicle (LRV), an Apollo
